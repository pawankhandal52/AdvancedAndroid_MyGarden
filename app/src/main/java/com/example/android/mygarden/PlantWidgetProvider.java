...
public class PlantWidgetProvider extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int img,
                                int appWidgetId) {
        ...
        views.setOnClickPendingIntent(img, pendingIntent);
    ...
    public static void updatePlantWidgets(Context context, AppWidgetManager appWidgetManager, int img,
                                          int [] appWidgetIds){
        for (int appWidget:appWidgetIds) {
                updateAppWidget(context,appWidgetManager,img,appWidget);
        }
    }
    @Override
