...
public class PlantWateringService extends IntentService {
    ...
    private void handleActionUpdatePlantWidget() {
        ...
        if (cursor != null && cursor.getCount()>0) {
            ...
            imgRes = PlantUtils.getPlantImageRes(this,timeNow-createdAt,timeNow-waterAt,plantType);
        }
    
        AppWidgetManager appWidgetManager = AppWidgetManager.getInstance(this);
        int [] appIds =  appWidgetManager.getAppWidgetIds(new ComponentName(this,PlantWidgetProvider.class));
        PlantWidgetProvider.updatePlantWidgets(this,appWidgetManager,imgRes,appIds);
    }
